...
<footer class="bg-white" aria-labelledby="footer-heading">
	...
	<div class="max-w-7xl mx-auto py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
		<div class="xl:grid xl:grid-cols-3 xl:gap-8">
			...
			<div class="mt-12 xl:mt-0 space-y-8 xl:col-span-1 text-gray-400">
				<svg
					fill="currentColor"
					stroke-width="1.5"
					stroke="currentColor"
				...
				>
					<g>
						<g>
							<path
								d="M510.565,323.799c-2.62-3.925-7.91-4.983-11.836-2.364l-23.45,15.633h-84.727c-1.672-7.33-4.378-14.259-7.987-20.634
			...
			C373.332,372.763,369.355,382.03,363.501,389.838z"
				...
				<p class="text-base text-gray-500">
					Empowering tech leaders through innovative education, mentorship, and hands-on experience.
				</p>
		...
		<div class="mt-12 border-t border-gray-200 pt-8">
			<p class="text-base text-gray-400 xl:text-center">
				&copy; {currentYear} DevPioneer Institute. All Rights Reserved.
			</p>
		</div>
	</div>
</footer>
