...
<div class="relative bg-white py-16 sm:py-24">
	<div class="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
		<h2 class="text-base font-semibold text-indigo-600 tracking-wider uppercase">Tools required</h2>
		<p class="mt-2 text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">
			Everything you need to succeed
		</p>
		<p class="mx-auto mt-5 max-w-prose text-xl text-gray-500">
			Web development is a constantly evolving field and these are the core technologies for
			building web pages and adding interactivity to them.
		</p>
		<div class="mt-12">
				...
				<div class="pt-6">
					<div class="flow-root rounded-lg bg-gray-50 px-6 pb-8">
						<div class="-mt-6">
							...
							<h3 class="mt-8 text-lg font-medium tracking-tight text-gray-900">HTML</h3>
							<p class="mt-5 text-base text-gray-500">
								HTML(HyperText Markup Language) is the standard markup language used to create and
								design the structure of web pages.
							</p>
						</div>
					</div>
				</div>
				<div class="pt-6">
					<div class="flow-root rounded-lg bg-gray-50 px-6 pb-8">
						<div class="-mt-6">
							...
							<h3 class="mt-8 text-lg font-medium tracking-tight text-gray-900">CSS</h3>
							<p class="mt-5 text-base text-gray-500">
								CSS(Cascading Style Sheets) is used to describe the presentation of a document
								written in HTML. It defines how HTML elements should be displayed on a web page.
							</p>
						</div>
					</div>
				</div>
				<div class="pt-6">
					<div class="flow-root rounded-lg bg-gray-50 px-6 pb-8">
						<div class="-mt-6">
							...
							<h3 class="mt-8 text-lg font-medium tracking-tight text-gray-900">Javascript</h3>
							<p class="mt-5 text-base text-gray-500">
								JavaScript is a high-level programming language that is commonly used to add
				...
				<div class="pt-6">
					<div class="flow-root rounded-lg bg-gray-50 px-6 pb-8">
						<div class="-mt-6">
							...
							<h3 class="mt-8 text-lg font-medium tracking-tight text-gray-900">PHP</h3>
							<p class="mt-5 text-base text-gray-500">
								PHP is a server-side scripting language commonly used for web development. It is
								often used to create dynamic web applications.
							</p>
						</div>
					</div>
				</div>
				<div class="pt-6">
					<div class="flow-root rounded-lg bg-gray-50 px-6 pb-8">
						<div class="-mt-6">
							...
							<h3 class="mt-8 text-lg font-medium tracking-tight text-gray-900">React</h3>
							<p class="mt-5 text-base text-gray-500">
								React is a JavaScript library for building user interfaces, developed by Facebook.
								It is commonly used for building single-page applications (SPAs) and dynamic user
								interfaces.
							</p>
						</div>
					</div>
				...
				<div class="pt-6">
					<div class="flow-root rounded-lg bg-gray-50 px-6 pb-8">
						<div class="-mt-6">
							...
							<h3 class="mt-8 text-lg font-medium tracking-tight text-gray-900">Laravel</h3>
							<p class="mt-5 text-base text-gray-500">
								Laravel is a PHP framework for building web applications, known for its elegant
