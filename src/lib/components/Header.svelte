		...
		>
			<div class="flex items-center">
				...
				<div class="hidden ml-10 space-x-8 lg:block">
					<a href="#" class="text-base font-medium text-gray-400 hover:text-gray-900">Price</a>
			...
			<div class="sm:ml-10 space-x-4">
				...
				<a
					href="#"
					class="inline-block bg-indigo-500 text-white py-2 px-4 border border-transparent rounded-md text-base font-medium hover:bg-indigo-500/75"
					>Sign up</a
				>
			</div>
		</div>
