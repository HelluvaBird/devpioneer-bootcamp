							...
							<div class="max-w-3xl space-y-6">
								...
								<div class="border border-gray-200 rounded-md">
									<div class="sm:hidden">
										...
										<select name="tabs" id="tabs" class="block w-full">
										...
										<div class="rounded-t-md bg-gray-50">
											<nav class="flex" aria-label="Tabs">
												<button
													...
													class:border-gray-200={currentTab !== 0}
												...
												<button
													...
													class:border-gray-200={currentTab !== 1}
												...
												<button
													...
													class:border-gray-200={currentTab !== 2}
												...
												<button
													...
													class:border-gray-200={currentTab !== 3}
									...
									<div class="p-6">
										<p class="text-3xl">We want this to always show</p>
									</div>
								</div>
							</div>
						</div>
