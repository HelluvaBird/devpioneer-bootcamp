<script lang="ts">
	...
	const program = {
		...
		subtitle: 'Blaze your trail with our top rated online cirriculum.',
		length: '15-30',
		rating: '4.8',
					...
					<div class="col-span-12 lg:col-span-8 lg:col-start-5">
						<div id="dpiexperience" data-scroll-spy="dpiexperience" class="pb-16">
							...
							<p class="max-w-3xl text-base mt-6">
								DevPioneer Institutes Online program is an immersive hands-on course. The online
								program is <span class="font-bold">self-paced</span>. Typically it takes between 15
								to 30 weeks to complete. For those pioneers looking to blaze their own trails.
							</p>
							<div class="mt-6">
								<p class="max-w-3xl text-xl sm:text-2xl font-extrabold text-gray-900">
									The Online program highlights
								</p>
								<div class="mt-6 grid grid-cols-2 gap-6 items-start">
									<div class="grid col-span-2 lg:col-span-1 space-y-2">
										...
										<h3 class="text-lg font-medium">Top rated Online program</h3>
								...
								<p class="text-2xl font-bold mt-16">
									Interested in the other programs DevPioneer Institute offers?
								</p>
								<div class="mt-6 grid grid-cols-2 gap-x-4 gap-y-8 lg:gap-6">
									...
									>
										<div class="h-40 overflow-hidden">
											<img
												src="/images/part-time.jpg"
												alt="woman sitting at computer working"
										...
										<div class="grid border-t border-gray-200 text-center p-6">
											<a
												...
												class="bg-gray-100 p-3 border rounded-lg tracking-widest font-medium hover:bg-gray-200"
												>Learn More</a
											>
										</div>
									</div>
						...
						<div class="py-16" id="trail" data-scroll-spy="trail">
							<div class="space-y-6">
								...
								<p class="text-2xl font-semibold">This journey is self-paced not solo.</p>
								<p class="text-lg max-w-3xl">
									Just because your learning on your own doesn't mean you have to do it alone. Our
									online forums are an expansive network of pioneers with whom you can build a
									lasting and beneficial relationship with. Many of our pioneers are working
									professionals and will offer you their support and guidance throughout your
									career.
								</p>
							</div>
						</div>
							...
							<div class="space-y-6">
								...
								<div class="bg-white shadow overflow-hidden rounded-md">
									<ul role="list" class="divide-y divide-gray-200">
										<div class="px-6 py-4">
											<p class="text-lg">
												The online program tuition is <span
													class="text-lg font-semibold text-indigo-700 tracking-tight">$5,000</span
												>
											</p>
						...
						<div class="py-16" id="careerprep" data-scroll-spy="careerprep">
							<div class="space-y-6">
								...
								<p class="max-w-3xl">
									DevPioneer Institute offers pioneers attending the Online program resume reviews
									upon request. DevPioneer Institute provides the guidance and tools you need to
									blaze your trail and land the ideal web developer role for you.
								</p>
								<div class="grid grid-cols-12 gap-x-4 gap-y-8 lg:gap-6 items-start">
									...
									<div class="col-span-12 lg:col-span-6 grid gap-2">
										...
										<p class="font-semibold">Online discussions</p>
										<p>
											DevPioneer Institute has a robust online forum of dedicated faculty and alumni
											that will answer your questions if one should arise during your studies.
										</p>
									</div>
								</div>
								<p class="pt-12 text-2xl font-semibold">
									What do the other DevPioneer programs have to offer
								</p>
								<div class="mt-6 grid grid-cols-2 gap-x-4 gap-y-8 lg:gap-6">
									<div
						...
						<div class="py-16" id="admissions" data-scroll-spy="admissions">
							<div class="space-y-6">
								...
								<p>
									The Online program is the exact same curriculum we teach in our part-time and
									full-time programs. It was developed by our top DevPioneer Institute scientists to
									challenge students throughout the program. Blazing your trail at your own pace
									with the same engaging and rewarding experience.
								</p>
								...
								<div class="grid grid-cols-12 gap-6 items-start">
									<div class="grid col-span-12 lg:col-span-4 gap-2">
										...
										<p>You need to be committed to learning the course material.</p>
									</div>
									<div class="grid col-span-12 lg:col-span-4 gap-2">
										<svg
											xmlns="http://www.w3.org/2000/svg"
